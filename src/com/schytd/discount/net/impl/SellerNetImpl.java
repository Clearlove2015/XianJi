...
public class SellerNetImpl extends ConnectInternetHelper implements SellerNet {
	public SellerNetImpl(Context c) {
		super(c);
	}
	...
	public SellerInfo getSellerInfoFromServer(String... params)
		...
		// {"errorToken":"@@$-ERROR_TOKEN$-@@","code":"33","message":"服务方法(bus.getBusinessList4Page:1.0)的参数非法","solution":"请查看根据服务接口对参数格式的要求","subErrors":[{"code":"isv.parameters-mismatch:industryId-and-","message":"传入的参数industryId和不匹配"},{"code":"isv.parameters-mismatch:propertyTypeId-and-","message":"传入的参数propertyTypeId和不匹配"}]}
