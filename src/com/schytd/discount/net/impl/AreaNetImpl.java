...
import com.schytd.discount.bean.AreaInfo;
...
public class AreaNetImpl extends ConnectInternetHelper implements AreaNet {
	public AreaNetImpl(Context c) {
		super(c);
	}
	...
	public List<AreaInfo> getArea(String... params) throws Exception {
		...
		NameValuePair parameter_parentkey = new BasicNameValuePair("parentKey", params[3]);
