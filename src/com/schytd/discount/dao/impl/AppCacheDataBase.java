...
public class AppCacheDataBase extends SQLiteOpenHelper {
	private static final String TAG = AppCacheDataBase.class.getSimpleName();

	// 定义一个数据库名字
	private static final String DB_NAME = "cache_database.db";
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String sql6 = "CREATE TABLE " + TABLE_CONSUM_HISTORY + " ("
				+ " userbaseinfo_id VARCHAR(20) PRIMARY KEY, "
				+ " business_name VARCHAR(20), " + " amount VARCHAR(20), "
				+ " consumption_time VARCHAR(20)," + " page VARCHAR(20)" + ")";
		db.execSQL(sql6);
		...
		String sql10 = "CREATE TABLE " + TABLE_USE_SCORE_HISTORY + " ("
				+ " userBaseId VARCHAR(20) ,"
				+ " score VARCHAR(20)," + " useType VARCHAR(20),"
				+ " useTime VARCHAR(20)," + "page VARCHAR(20)" + ") ";
		db.execSQL(sql10);
		// 推送消息表
