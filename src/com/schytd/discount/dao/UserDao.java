...
public interface UserDao {
	...
	// 查询消费列表
	public ArrayList<ConsumHistoryItem> selectConsumHistory(String page) throws Exception;
	// 查询积分列表
	public ArrayList<ScoreGetHistoryItem> selectScoreHistory(String page) throws Exception;
