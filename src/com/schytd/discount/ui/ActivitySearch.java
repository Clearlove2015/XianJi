...
public class ActivitySearch extends BaseActivity {
	...
	private TextView mButtonFlat_search;
	// 搜索历史
	private ListView mListView;
	private List<String> mData;
	// 清空历史
	private LinearLayout mLayoutRipple;
	private SharedPreferences sp;
	// 热门搜索
	private TextView mTextView_one, mTextView_two, mTextView_three, mTextView_four, mTextView_five, mTextView_six;
	private LinearLayout mClear_Search_His;
	...
	private void init() {
		mClear_Search_His = (LinearLayout) this.findViewById(R.id.clear_search_his);
		...
		mLayoutRipple = (LinearLayout) this.findViewById(R.id.clear_search_his);
		...
		case 1:
			...
			if (!StrTools.isNull(two)) {
				mData.add(two);
				Toast.makeText(ActivitySearch.this, "++++++", Toast.LENGTH_SHORT).show();
			}
			if (!StrTools.isNull(one)) {
				mData.add(one);
			}
		...
		mImageViewSearch = (ImageView) this.findViewById(R.id.search_back);
		mEditTextSearch = (EditText) this.findViewById(R.id.et_search);
		mButtonFlat_search = (TextView) this.findViewById(R.id.search_btn);
	...
	private BaseAdapter mAdapter = new BaseAdapter() {
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			ImageView imageView = (ImageView) convertView.findViewById(R.id.iv_search_icon);
	...
	private void searchBack(String search) {
		if (StrTools.isNull(search)) {
			Toast.makeText(ActivitySearch.this, "请输入搜索内容~", Toast.LENGTH_SHORT).show();
			return;
		}
		Editor editor = sp.edit();
		int count = sp.getInt("count", 0);
