...
package com.schytd.discount.ui.camera;
...
public final class CameraManager {
  ...
  public static void init(Context context) {
    if (cameraManager == null) {
      ...
      MAX_FRAME_WIDTH = (int) context.getResources().getDimension(R.dimen.x240);
      MAX_FRAME_HEIGHT = (int) context.getResources().getDimension(R.dimen.y180);
    }
  }
