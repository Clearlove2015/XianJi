package com.schytd.discount.ui.switchbtn.togglebutton;

import com.schytd.discount.ui.switchbtn.rebound.SimpleSpringListener;
import com.schytd.discount.ui.switchbtn.rebound.Spring;
import com.schytd.discount.ui.switchbtn.rebound.SpringConfig;
import com.schytd.discount.ui.switchbtn.rebound.SpringSystem;
import com.schytd.discount.ui.switchbtn.rebound.SpringUtil;
...
public class ToggleButton extends View {
	...
	/** 开启颜色 */
	private int onColor = Color.parseColor("#ffd34e");
	/** 关闭颜色 */
	...
	private ToggleButton(Context context) {
		...
		sp = context.getSharedPreferences("msg-on", Context.MODE_PRIVATE);
	}
	...
	public void toggle(boolean animate) {
		...
		// 消息设置
		editor.putBoolean("isOn", animate);
		editor.commit();
