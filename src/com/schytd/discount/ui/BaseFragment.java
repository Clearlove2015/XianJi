...
public class BaseFragment extends Fragment {
	...
	public DisplayImageOptions setImg() {
		// *************
		DisplayImageOptions options = new DisplayImageOptions.Builder().showImageOnLoading(R.drawable.list_default)
				.showImageOnFail(R.drawable.list_default).cacheInMemory(true).cacheOnDisc(true).considerExifParams(true)
