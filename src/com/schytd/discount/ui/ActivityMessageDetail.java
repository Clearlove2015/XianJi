...
public class ActivityMessageDetail extends FragmentActivity {
	...
	private TextView mTextView_title, mTextView_name, mTextView_date, mTextView_abstractinfo, mTextView_detail;
	// loading
	...
	private void init() {
		...
		mTextView_abstractinfo = (TextView) this.findViewById(R.id.message_abstract);
	...
	private class MessageTask extends AsyncTask<String, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			...
			if (mPushInfo != null) {
				...
				// 为空。。。。。
				Toast.makeText(ActivityMessageDetail.this, "网络请求出错！", Toast.LENGTH_SHORT).show();
			}
